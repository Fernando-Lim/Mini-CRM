                    ...
                    <form action="{{ route('sells.update',$sell->id)}}" method="POST">
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control price-input" name="price" value="{{ $sell->price }}" readonly>
                                @include('layouts.error', ['name' => 'price'])
                            </div>
                            <div class="col-6">
                                <label for="">{{trans('sell.table4') }}</label>
                                <input type="number" class="form-control" name="discount" value="{{ $sell->discount }}">
